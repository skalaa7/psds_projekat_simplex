...
HD_PWD='c:/users/andrej/vhdl_projects/ip_repo/edit_PIVOT_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PIVOT_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PIVOT_v1_0.tcl
