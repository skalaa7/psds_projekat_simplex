...
HD_PWD='C:/Users/Andrej/VHDL_projects/Simplex/Simplex.runs/simplex_axi_bram_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simplex_axi_bram_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simplex_axi_bram_ctrl_0_0.tcl
