...
HD_PWD='/home/student/Git/psds_projekat_simplex/Simplex/Simplex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simplex_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simplex_wrapper.tcl
