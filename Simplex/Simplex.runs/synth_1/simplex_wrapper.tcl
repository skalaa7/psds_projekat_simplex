...
synth_design -top simplex_wrapper -part xc7z010clg400-1
...
write_checkpoint -force -noxdef simplex_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file simplex_wrapper_utilization_synth.rpt -pb simplex_wrapper_utilization_synth.pb"
