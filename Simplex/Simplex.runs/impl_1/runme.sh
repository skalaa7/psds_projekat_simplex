...
HD_PWD='/home/student/Git/psds_projekat_simplex/Simplex/Simplex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simplex_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simplex_wrapper.tcl -notrace
