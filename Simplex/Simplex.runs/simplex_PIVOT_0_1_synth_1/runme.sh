...
HD_PWD='C:/Users/Andrej/VHDL_projects/Simplex/Simplex.runs/simplex_PIVOT_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simplex_PIVOT_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simplex_PIVOT_0_1.tcl
