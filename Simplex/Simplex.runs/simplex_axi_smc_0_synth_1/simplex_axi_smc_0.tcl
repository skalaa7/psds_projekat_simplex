...
namespace eval ::optrace {
  variable script "C:/Users/Andrej/VHDL_projects/Simplex/Simplex.runs/simplex_axi_smc_0_synth_1/simplex_axi_smc_0.tcl"
...
OPTRACE "simplex_axi_smc_0_synth_1" START { ROLLUP_AUTO }
...
read_ip -quiet c:/Users/Andrej/VHDL_projects/Simplex/Simplex.srcs/sources_1/bd/simplex/ip/simplex_axi_smc_0/simplex_axi_smc_0.xci
...
set cached_ip [config_ip_cache -export -no_bom  -dir C:/Users/Andrej/VHDL_projects/Simplex/Simplex.runs/simplex_axi_smc_0_synth_1 -new_name simplex_axi_smc_0 -ip [get_ips simplex_axi_smc_0]]
...
synth_design -top simplex_axi_smc_0 -part xc7z010clg400-1 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix simplex_axi_smc_0_ simplex_axi_smc_0.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ simplex_axi_smc_0_stub.v
 lappend ipCachedFiles simplex_axi_smc_0_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ simplex_axi_smc_0_stub.vhdl
 lappend ipCachedFiles simplex_axi_smc_0_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ simplex_axi_smc_0_sim_netlist.v
 lappend ipCachedFiles simplex_axi_smc_0_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ simplex_axi_smc_0_sim_netlist.vhdl
 lappend ipCachedFiles simplex_axi_smc_0_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp simplex_axi_smc_0.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips simplex_axi_smc_0]
 }
...
rename_ref -prefix_all simplex_axi_smc_0_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef simplex_axi_smc_0.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "simplex_axi_smc_0_synth_1_synth_report_utilization_0" "report_utilization -file simplex_axi_smc_0_utilization_synth.rpt -pb simplex_axi_smc_0_utilization_synth.pb"
OPTRACE "synth reports" END { }

if { [catch {
  file copy -force C:/Users/Andrej/VHDL_projects/Simplex/Simplex.runs/simplex_axi_smc_0_synth_1/simplex_axi_smc_0.dcp c:/Users/Andrej/VHDL_projects/Simplex/Simplex.gen/sources_1/bd/simplex/ip/simplex_axi_smc_0/simplex_axi_smc_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub c:/Users/Andrej/VHDL_projects/Simplex/Simplex.gen/sources_1/bd/simplex/ip/simplex_axi_smc_0/simplex_axi_smc_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub c:/Users/Andrej/VHDL_projects/Simplex/Simplex.gen/sources_1/bd/simplex/ip/simplex_axi_smc_0/simplex_axi_smc_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim c:/Users/Andrej/VHDL_projects/Simplex/Simplex.gen/sources_1/bd/simplex/ip/simplex_axi_smc_0/simplex_axi_smc_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim c:/Users/Andrej/VHDL_projects/Simplex/Simplex.gen/sources_1/bd/simplex/ip/simplex_axi_smc_0/simplex_axi_smc_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force C:/Users/Andrej/VHDL_projects/Simplex/Simplex.runs/simplex_axi_smc_0_synth_1/simplex_axi_smc_0_stub.v c:/Users/Andrej/VHDL_projects/Simplex/Simplex.gen/sources_1/bd/simplex/ip/simplex_axi_smc_0/simplex_axi_smc_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/Users/Andrej/VHDL_projects/Simplex/Simplex.runs/simplex_axi_smc_0_synth_1/simplex_axi_smc_0_stub.vhdl c:/Users/Andrej/VHDL_projects/Simplex/Simplex.gen/sources_1/bd/simplex/ip/simplex_axi_smc_0/simplex_axi_smc_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/Users/Andrej/VHDL_projects/Simplex/Simplex.runs/simplex_axi_smc_0_synth_1/simplex_axi_smc_0_sim_netlist.v c:/Users/Andrej/VHDL_projects/Simplex/Simplex.gen/sources_1/bd/simplex/ip/simplex_axi_smc_0/simplex_axi_smc_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/Users/Andrej/VHDL_projects/Simplex/Simplex.runs/simplex_axi_smc_0_synth_1/simplex_axi_smc_0_sim_netlist.vhdl c:/Users/Andrej/VHDL_projects/Simplex/Simplex.gen/sources_1/bd/simplex/ip/simplex_axi_smc_0/simplex_axi_smc_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir C:/Users/Andrej/VHDL_projects/Simplex/Simplex.ip_user_files/ip/simplex_axi_smc_0]} {
  catch { 
    file copy -force c:/Users/Andrej/VHDL_projects/Simplex/Simplex.gen/sources_1/bd/simplex/ip/simplex_axi_smc_0/simplex_axi_smc_0_stub.v C:/Users/Andrej/VHDL_projects/Simplex/Simplex.ip_user_files/ip/simplex_axi_smc_0
  }
}

if {[file isdir C:/Users/Andrej/VHDL_projects/Simplex/Simplex.ip_user_files/ip/simplex_axi_smc_0]} {
  catch { 
    file copy -force c:/Users/Andrej/VHDL_projects/Simplex/Simplex.gen/sources_1/bd/simplex/ip/simplex_axi_smc_0/simplex_axi_smc_0_stub.vhdl C:/Users/Andrej/VHDL_projects/Simplex/Simplex.ip_user_files/ip/simplex_axi_smc_0
  }
}
file delete __synthesis_is_running__
close [open __synthesis_is_complete__ w]
OPTRACE "simplex_axi_smc_0_synth_1" END { }
