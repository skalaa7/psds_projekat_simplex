...
HD_PWD='C:/Users/Andrej/VHDL_projects/delitelj/najnoviji/project_7/project_7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_pivot.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_pivot.tcl
